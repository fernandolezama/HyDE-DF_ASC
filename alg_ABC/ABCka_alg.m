...
function [Fit_and_p,FVr_bestmemit, fitMaxVector, Best_otherInfo] = ...
    ABCka_alg(abckaParameters,otherParameters,low_habitat_limit,up_habitat_limit)


%/* Control Parameters of ABC algorithm*/
NP=abckaParameters.NP; %/* The number of colony size (employed bees+onlooker bees)*/
FoodNumber=NP/2; %/*The number of food sources equals the half of the colony size*/
limit=FoodNumber*otherParameters.dim; %/*A food source which could not be improved through "limit" trials is abandoned by its employed bee*/
maxCycle=abckaParameters.maxCycle; %/*The number of cycles for foraging {a stopping criteria}*/
...
D=otherParameters.dim;             % Number of Decision Variables
lb=ones(1,D)*otherParameters.lowerlimit;         % Decision Variables Lower Bound
ub=ones(1,D)* otherParameters.upperlimit;         % Decision Variables Upper Bound
